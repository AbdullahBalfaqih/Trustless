...
const metrics = [
  { 
    ...
    suffix: "", 
    prefix: "$",
    label: "Total payments escrowed",
    sublabel: "in Palm USD",
  },
  { 
    value: 99, 
    suffix: ".9%", 
    ...
    sublabel: "dispute-free releases",
  },
  { 
    value: 0, 
    suffix: "", 
    prefix: "",
    label: "Funds lost",
    sublabel: "smart contract secured",
  },
];
  ...
  return (
    <section className="relative py-32 lg:py-40 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-8 mb-20 lg:mb-32">
          <div className="lg:col-span-8 lg:col-start-1">
            <FadeIn className="flex items-center gap-4 mb-6">
              <span className="flex items-center gap-2 px-3 py-1 bg-[#4ade80]/10 text-[#4ade80] text-xs font-mono">
                <motion.span 
            ...
            <FadeIn delay={0.1}>
              <h2 className="text-6xl md:text-7xl lg:text-[140px] font-display tracking-tight leading-[0.95]">
                Real-time
                <br />
                <span className="text-muted-foreground">platform metrics.</span>
              </h2>
            </FadeIn>
          </div>
        </div>
        ...
        {/* Organic graph image */}
        <FadeIn delay={0.3} className="w-full mb-0">
          <img
            src="/images/flat.png"
            alt="Platform Panorama"
        ...
        <StaggerContainer className="grid lg:grid-cols-3 gap-6">
          {/* Large metric */}
          <StaggerItem className="lg:col-span-1 bg-foreground/[0.02] border border-foreground/10 p-10 lg:p-14">
        ...
        {/* Bottom ticker */}
        <FadeIn delay={0.6} className="mt-16 pt-8 border-t border-foreground/10 flex flex-wrap items-center gap-x-12 gap-y-4 text-sm font-mono text-muted-foreground">
          <span>Solana Blockchain</span>
          <span>Palm USD Stablecoin</span>
