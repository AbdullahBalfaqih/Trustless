...
const features = [
  ...
  { 
    ...
    description: "Automated work quality assessment and scoring."
  },
  { 
    title: "Palm USD payments", 
    description: "Stable escrow with instant settlement."
  },
  { 
    title: "Open smart contracts", 
    description: "Audited and open-source on-chain logic."
  },
];
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <h2 className="text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9]">
            Build on Web3.
            <br />
            <span className="text-muted-foreground">Own your work.</span>
          </h2>
        </div>
        ...
        >
          <p className="text-xl text-muted-foreground mb-12 leading-relaxed max-w-md">
            Open smart contracts, AI-powered verification, and transparent 
            on-chain reputation. Built for the decentralized future.
          </p>
