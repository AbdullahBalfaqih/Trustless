...
const securityFeatures = [
  {
    ...
    description: "Funds locked in audited smart contracts.",
    image: "/images/isolated.jpg",
  },
  {
    icon: Lock,
    title: "Wallet-Only Access",
    description: "No passwords, no data breaches possible.",
    image: "/images/encrypted.jpg",
  },
  {
    icon: Eye,
    title: "On-Chain Transparency",
    description: "Every transaction publicly verifiable.",
    image: "/images/audit.jpg",
  },
  {
    icon: FileCheck,
    title: "AI Dispute Resolution",
    description: "Automated fair arbitration system.",
    image: "/images/permissions.jpg",
  },
];

const certifications = ["Audited", "Open Source", "Solana", "Palm USD"];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-20">
          ...
          <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.9] mb-12 transition-all duration-1000 ${
            ...
            Trustless,
            <br />
            <span className="text-muted-foreground">not risky.</span>
          </h2>
          ...
          <div className={`transition-all duration-1000 delay-100 ${
            ...
            <p className="text-xl text-muted-foreground leading-relaxed max-w-2xl">
              Your funds are secured by smart contracts. No intermediaries, no counterparty risk, just code.
            </p>
          </div>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          ...
          <div className={`lg:col-span-7 relative p-8 lg:p-12 border border-foreground/10 min-h-[400px] overflow-hidden transition-all duration-700 ${
            ...
            <div className="relative z-10">
              <span className="font-mono text-sm text-muted-foreground">Smart Contract Secured</span>
              <div className="mt-8">
                <span className="text-7xl lg:text-8xl font-display">0</span>
                <span className="block text-muted-foreground mt-2">Funds lost to disputes</span>
              </div>
            </div>
