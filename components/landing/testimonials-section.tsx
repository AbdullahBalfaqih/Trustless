...
const testimonials = [
  {
    quote: "Finally a platform where I get paid instantly without worrying about chargebacks or disputes. The AI verification is a game-changer.",
    author: "Alex Rivera",
    role: "Freelance Developer",
    company: "Web3 Builder",
    metric: { value: "100%", label: "Payment success" },
  },
  {
    quote: "The micro-escrow system lets me test new freelancers risk-free. Small tasks, instant trust building.",
    author: "Maya Patel",
    role: "Founder",
    company: "DeFi Studio",
    metric: { value: "50+", label: "Jobs completed" },
  },
  {
    quote: "No signup, just connect wallet and start earning. This is how Web3 should work. Simple and trustless.",
    author: "Jordan Kim",
    role: "Smart Contract Dev",
    company: "Solana Labs",
    metric: { value: "0", label: "Trust issues" },
  },
  {
    quote: "My on-chain reputation follows me everywhere. Clients trust me instantly because the blockchain doesn't lie.",
    author: "Chris Santos",
    role: "UI/UX Designer",
    company: "Phantom Wallet",
    metric: { value: "95", label: "Trust score" },
  },
];
...
export function TestimonialsSection() {
  ...
  // Deterministic pseudo-random pattern (seeded by position) — no SSR/client mismatch
  const asciiPattern = Array.from({ length: 60 }, (_, row) =>
    Array.from({ length: 100 }, (__, col) => {
      // Simple seeded hash: (row * 31 + col * 17) % 10 > 7 gives ~30% density
      const seed = (row * 31 + col * 17 + row * col) % 10;
      return seed > 6 ? '"' : ' ';
    }).join("")
  ).join("\n");
