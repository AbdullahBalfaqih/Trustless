...
const steps = [
  {
    ...
    description: "No email, no passwords. Simply connect your Solana wallet to get instant access to the platform.",
    code: `await wallet.connect({
  provider: 'Phantom',
  ...
  },
  {
    number: "02",
    title: "Create",
    subtitle: "or accept job",
    description: "Post a micro task or browse available jobs. Lock payment in escrow with Palm USD instantly.",
    code: `await escrow.create({
  ...
  },
  {
    ...
    title: "Verify",
    subtitle: "& release",
    description: "AI verifies completed work quality. Upon approval, payment is instantly released to the freelancer.",
    code: `await ai.verify({
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-8">
                <span className={`text-4xl font-display transition-colors duration-300 ${
                  activeStep === index ? "text-[#10b981]" : "text-white/20"
                }`}>
                  {step.number}
                </span>
                <div className="flex-1 h-px bg-white/10 overflow-hidden">
                  {activeStep === index && (
                    <div className="h-full bg-[#10b981]/50 animate-progress" />
                  )}
                </div>
              </div>
              ...
              {/* Active indicator */}
              <div className={`absolute bottom-0 left-0 right-0 h-1 bg-[#10b981] transition-transform duration-500 origin-left ${
